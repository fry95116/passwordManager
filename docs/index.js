...
exports.emit = function (eventID) {
    ...
    if (eventID in global_listeners) {
        ...
        try {
            for (var _iterator = (0, _getIterator3.default)(global_listeners[eventID]), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
},{"babel-runtime/core-js/get-iterator":1}],56:[function(require,module,exports){
'use strict';
